...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
          "service_bl1lk1u", // Service ID
          "template_skz4vyu", // Template ID
          userInput,
          "F2RRGV4j3w4MIeZtS" // Public Key - https://dashboard.emailjs.com/admin/account
        )
          .then((response) => {
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
            ...
            <div className="flex flex-col gap-2">
              <label
                htmlFor="from_name"
                className="text-[16px] text-[#CCCCCC]  uppercase"
              >
                Your name<sup>*</sup>
              </label>
              <input
                name="from_name"
                type="text"
                className="h-[64px] bg-[#CCCCCC] text-[24px] outline-none border-none text-black  border px-4"
                required
                autoComplete="off"
                onChange={onChange}
              />
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                name="from_email"
                type="email"
                className="h-[64px] bg-[#CCCCCC] text-[24px] outline-none border-none text-black px-4"
                required
                autoComplete="off"
                onChange={onChange}
              />
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              name="message"
              className="h-[162px] bg-[#CCCCCC]  text-[24px] outline-none border-none text-black p-4 resize-none"
              required
              onChange={onChange}
            />
          </div>
