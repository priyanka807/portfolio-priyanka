        ...
        {projectData.map((item, index) => {
          return (
            <Div key={index} className="flex flex-col gap-4 cursor-pointer">
              ...
              <div className="text-[12px] 2xl:text-[18px] text-white tracking-wide ">
                {item.dis}
              </div>
              <div className="text-[16px] 2xl:text-[20px] text-[#CCCCCC] text-center bg-gradient-to-r from-purple-900 to-orange-600 rounded-full p-1  ">
                {item.ts}
              </div>
            </Div>
          );
